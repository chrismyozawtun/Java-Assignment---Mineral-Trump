...
public class SuperTrumpCard {
    ...
    public SuperTrumpCard(int id, String fileName, String imageName, String card_type, String tittle, String chemistry, String classification,
                          String crystal_system, String hardness, String specifc_gravity, String cleavage, String crustal_abundance, String economic_value, String occurence, String subtitle) {
        this.id = id;
