...
public class SuperTrumpPlayers {
    ...
    public void printCardsforPlay() {
        ...
        for (int i = 0; i < cards.size(); i++) {
            System.out.println("#" + i + " = " + String.valueOf(cards.get(i)) + " Id: " + cards.get(i).getID() + " Hardness: " + cards.get(i).getHardness() + " Specific gravity: " + cards.get(i).getSpecifc_gravity() + " Cleavage: " + cards.get(i).getCleavage() + " Crustal Abundance: " + cards.get(i).getCrustal_abundance() + " Economic value: " + cards.get(i).getEconomic_value());
        }
    }
    ...
    public SuperTrumpCard playCardGUI(int index) {
        SuperTrumpCard removedCard;
        System.out.println("The card is: " + cards.get(index).gettittle());
        removedCard = cards.remove(index);
        return removedCard;
